...
public class UpdateValuesServlet extends HttpServlet {
    ...
    private final String UPDATE_FOOD_PAGE = "updateFoodPage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (foodID != null) {
                ...
                if (food != null) {
                    request.setAttribute("UPDATEVALUES", food);
                    url = UPDATE_FOOD_PAGE;
                }
            }
        } catch (SQLException ex) {
            log("UpdateValues _ SQL " + ex.getMessage());
        } catch (NamingException ex) {
            log("UpdateValues _ Naming " + ex.getMessage());
        } finally {
